        ...
        <?php foreach ($courses as $course): ?>
            <tr>
                ...
                <td><?= h($course->total_video_time) ?></td>
                    <td class="actions">
                    <?= $this->Html->link('<span class="fa fa-plus"></span><span class="sr-only">' . __('Add Course Content') . '</span>', ['action' => 'view', $course->id], ['escape' => false, 'class' => 'btn-default', 'title' => __('Add Course Content')]) ?>
