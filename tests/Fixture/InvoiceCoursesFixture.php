...
/**
 * InvoiceCoursesFixture
 */
class InvoiceCoursesFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'net_price' => ['type' => 'float', 'length' => 10, 'precision' => 2, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => ''],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'discount' => 1,
                'net_price' => 1,
                'create_date' => '2021-07-28 14:46:51',
                'invoice_no' => 1,
            ],
        ];
        parent::init();
