 ...
 * CartCoursesFixture
 */
class CartCoursesFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'courese_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'discount' => 1,
                'net_price' => 1,
                'create_date' => '2021-07-28 14:46:25',
                'user_id' => 1,
            ],
        ];
        parent::init();
